...
const main = async () => {
   ...
   // console.log(arrayList);
   await filterCategory('Tình Cảm', '.category-romance');
   await filterCategory('Hành Động', '.category-action', 'Nhật Bản');
   await filterCategory('Kinh Dị', '.category-horror');
   await filterCategory('Hài Hước', '.category-comedy', 'Nhật Bản');
   await filterCategory('Viễn Tưởng', '.category-ScienceFiction', 'Nhật Bản');
   await filterCategory('Phim 18+', '.category-Movie18');

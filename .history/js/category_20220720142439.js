...
const renderTitle = async (data, listSelector) => {
   const titleCategory = document.querySelector(listSelector);
   if (!listMovie) {
      console.error("List movie doesn't exit...");
      return;
   }
   let htmls = `<h2>Phim ${data}</h2>`;
